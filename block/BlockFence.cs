...
namespace jfcraft.block
{
	...
	public class BlockFence : BlockBase
	{
	  private static GLModel model;
	  public BlockFence(string id, string[] names, string[] images) : base(id, names, images)
	  {
		isOpaque = false;
		isAlpha = false;
		hasShape = true;
	  ...
	  public override bool canSupportBlock(Coords c)
	  {
		return c.dir == B;
	  }
	  public override int PreferredDir
	  {
		  get
		  {
			return EB | WB;
