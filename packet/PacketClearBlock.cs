...
namespace jfcraft.packet
{
	...
	public class PacketClearBlock : Packet
	{
	  ...
	  public PacketClearBlock(sbyte cmd) : base(cmd)
	  {
	  }

	  public PacketClearBlock(sbyte cmd, int i1, int i2, int i3, int i4, int i5, bool particles) : base(cmd)
	  {
		this.i1 = i1;
		this.i2 = i2;
		this.i3 = i3;
