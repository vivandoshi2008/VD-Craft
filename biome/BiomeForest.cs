namespace jfcraft.biome
{
	...
	public class BiomeForest : BiomeBase
	{
	  ...
	  private const int TREE_ODDS = 50;
	  private const int FLOWER_CHUNK_ODDS = 100;
	  private const int FLOWER_BLOCK_ODDS = 100;
	  private const int TALLGRASS_CHUNK_ODDS = 100;
	  private const int TALLGRASS_BLOCK_ODDS = 100;
